const page = () => {
  return (
    <section className="max-w-4xl mx-auto py-20 space-y-4 px-8">
      <div className="text-sm text-white">Get in touch or shoot me an email directly on darnzykay@gmail.com</div>
      <form 
      action="https://formsubmit.co/darnzykay@gmail.com" method="POST"
      ...
      >
        ...
        <input type="hidden" name="_next" value="https://danielakinyemi.vercel.app/getintouch"></input>
